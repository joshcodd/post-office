...
<body class="font-sans antialiased ">
    ...
    <div class="flex flex-col h-screen ">
        <div class="flex min-w-full justify-center items-center flex-grow ">
            ...
            <div class="relative text-center h-full flex justify-center items-center  pt-0 bg-gray-100  w-1/2 ">
            ...
            <div class="h-full flex justify-center items-center pt-6 sm:pt-0 bg-gray-50  w-1/2 z-10">
